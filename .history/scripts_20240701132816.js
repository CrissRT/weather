...
document.addEventListener("DOMContentLoaded", function() {
    ...
    async function submit_process(event) {
        ...
        const wrapper_additional_weather_info_html_element = document.createElement("div"); //Using for humidity, wind speed, etc.
        ...
        main_app.appendChild(weather_description_html_element)
        main_app.appendChild(wrapper_additional_weather_info_html_element);
