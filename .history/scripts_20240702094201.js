...
document.addEventListener("DOMContentLoaded", function() {
    ...
    async function submit_process(event) {
        ...
        while (wrapper_for_all_weathor_info_html_element.firstChild){
            wrapper_for_all_weathor_info_html_element.removeChild(wrapper_for_all_weathor_info_html_element.firstChild)
        }
