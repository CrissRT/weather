...
document.addEventListener("DOMContentLoaded", function() {
    ...
    async function submit_process(event) {
        ...
        const additional_weather_info_html_element = document.createElement("div"); //Using for humidity, wind speed, etc.
        ...
        main_app.appendChild(additional_weather_info_html_element);
