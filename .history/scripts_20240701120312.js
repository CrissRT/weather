...
document.addEventListener("DOMContentLoaded", function() {
    ...
    async function submit_process(event) {
        ...
        try {
            const geolocation_data =  geolocation_api(fetch_link);
        ...
        for (data in locations_data_tags) {
            data.addEventListener("click", () => {
                ...
                const fetch_weather_link = `https://api.openweathermap.org/data/2.5/weather?q=${location_data}&appid=YOUR_OPEN_WEATHER_MAP_API_KEY`;
