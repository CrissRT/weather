    ...
    async function submit_process(event) {
        ...
        for (data in locations_data_tags) {
            data.addEventListener("click", () => {
                ...
                const fetch_weather_link = `https://api.open-meteo.com/v1/forecast?latitude=${data.long}&longitude=${data.lon}&current=temperature_2m,wind_speed_10m&hourly=precipitation_probability&forecast_days=1`;
