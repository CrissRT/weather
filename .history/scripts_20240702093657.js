...
document.addEventListener("DOMContentLoaded", function() {
    ...
    async function submit_process(event) {
        ...
        main_app.replaceChild(h2);
        main_app.replaceChild(h3);
        main_app.replaceChild(weather_description_html_element)
        main_app.replaceChild(wrapper_additional_weather_info_html_element);
    }
